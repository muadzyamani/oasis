    ...
    >
      ...
      {[
        // Frond 1: Strong right
        {
          ...
          grad: 'frondGrad',
          lines: [['365,102', '385,85'], ['390,92', '412,75'], ['415,82', '438,68'], ['440,75', '458,65'], ['365,108', '380,122'], ['390,102', '408,115'], ['415,95', '435,105']],
          color: '#2E7D32',
          opacity: 0.92
        },
        // Frond 2: Far right drooping
        {
          ...
          grad: 'frondGrad',
          lines: [['370,132', '385,120'], ['395,148', '412,135'], ['420,168', '438,155'], ['370,138', '380,158'], ['395,158', '407,178'], ['420,180', '432,200']],
          color: '#2E7D32',
          opacity: 0.85
        },
        // Frond 3: Slight left (fighting wind)
        {
          ...
          grad: 'frondGrad2',
          lines: [['320,105', '305,90'], ['300,98', '285,85'], ['280,92', '268,82'], ['320,112', '308,125'], ['300,108', '288,120']],
          color: '#388E3C',
          opacity: 0.88
        },
        // Frond 4: Up-right
        {
          ...
          grad: 'frondGrad2',
          lines: [['350,90', '338,72'], ['360,65', '350,45'], ['370,40', '362,20'], ['355,98', '372,90'], ['368,75', '385,65'], ['378,50', '392,38']],
          color: '#388E3C',
          opacity: 0.85
        },
        // Frond 5: Right horizontal low
        {
          ...
          grad: null,
          solidFill: '#388E3C',
          lines: [['365,120', '380,108'], ['390,122', '408,112'], ['415,128', '432,120'], ['365,128', '378,142'], ['390,132', '405,145']],
          color: '#2E7D32',
          opacity: 0.88
        }
      ].map((frond, idx) => (
