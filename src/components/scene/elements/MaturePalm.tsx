      ...
      {[
        {
          ...
          grad: 'frondGrad',
          lines: [
            ['215,128', '240,105'], ['230,118', '257,93'], ['245,108', '275,83'],
            ['260,98', '292,75'], ['275,90', '308,68'], ['290,82', '323,62'],
            ['305,74', '333,58'], ['215,132', '233,145'], ['230,123', '250,135'],
            ['245,115', '267,125'], ['260,107', '283,115'], ['275,99', '300,107'],
            ['290,92', '315,98'],
          ],
          color: '#2E7D32',
          opacity: 0.95,
        },
        {
          ...
          grad: 'frondGrad2',
          lines: [
            ['225,138', '245,115'], ['250,132', '273,108'], ['275,128', '300,103'],
            ['300,124', '325,100'], ['325,121', '347,102'], ['225,144', '240,162'],
            ['250,142', '267,158'], ['275,140', '295,155'], ['300,137', '320,150'],
            ['325,134', '343,146'],
          ],
          color: '#388E3C',
          opacity: 0.92,
        },
        {
          ...
          grad: 'frondGrad',
          lines: [
            ['225,162', '240,145'], ['250,175', '267,158'], ['275,190', '293,172'],
            ['295,208', '315,190'], ['313,228', '333,210'], ['225,168', '235,190'],
            ['250,183', '262,208'], ['275,202', '287,228'], ['295,222', '308,248'],
            ['313,243', '325,268'],
          ],
          color: '#2E7D32',
          opacity: 0.88,
        },
        {
          ...
          grad: 'frondGrad',
          lines: [
            ['170,128', '145,105'], ['155,118', '127,93'], ['140,108', '110,83'],
            ['125,98', '93,75'], ['110,90', '77,68'], ['95,82', '62,62'],
            ['80,74', '52,58'], ['170,132', '152,145'], ['155,123', '135,135'],
            ['140,115', '118,125'], ['125,107', '102,115'], ['110,99', '85,107'],
            ['95,92', '70,98'],
          ],
          color: '#2E7D32',
          opacity: 0.95,
        },
        {
          ...
          grad: 'frondGrad2',
          lines: [
            ['160,138', '140,115'], ['135,132', '112,108'], ['110,128', '85,103'],
            ['85,124', '60,100'], ['60,121', '38,102'], ['160,144', '145,162'],
            ['135,142', '118,158'], ['110,140', '90,155'], ['85,137', '65,150'],
            ['60,134', '42,146'],
          ],
          color: '#388E3C',
          opacity: 0.92,
        },
        {
          ...
          grad: 'frondGrad',
          lines: [
            ['160,162', '145,145'], ['135,175', '118,158'], ['110,190', '92,172'],
            ['90,208', '70,190'], ['72,228', '52,210'], ['160,168', '150,190'],
            ['135,183', '123,208'], ['110,202', '98,228'], ['90,222', '77,248'],
            ['72,243', '60,268'],
          ],
          color: '#2E7D32',
          opacity: 0.88,
        },
        {
          ...
          solidFill: '#43A047',
          lines: [
            ['187,120', '165,105'], ['185,100', '163,82'], ['184,80', '163,60'],
            ['184,60', '165,40'], ['185,40', '168,20'], ['186,20', '173,5'],
            ['199,120', '220,105'], ['201,100', '222,82'], ['202,80', '222,60'],
            ['202,60', '220,40'], ['201,40', '217,20'], ['200,20', '212,5'],
          ],
          color: '#2E7D32',
          opacity: 0.95,
        },
        {
          ...
          grad: 'frondGrad2',
          lines: [
            ['205,120', '190,98'], ['215,100', '203,75'], ['225,80', '215,55'],
            ['235,62', '227,35'], ['245,45', '240,20'], ['210,125', '233,115'],
            ['223,105', '247,92'], ['233,88', '258,72'], ['243,70', '267,52'],
            ['253,50', '273,32'],
          ],
          color: '#388E3C',
          opacity: 0.9,
        },
        {
          ...
          grad: 'frondGrad2',
          lines: [
            ['180,120', '195,98'], ['170,100', '182,75'], ['160,80', '170,55'],
            ['150,62', '158,35'], ['140,45', '145,20'], ['175,125', '152,115'],
            ['162,105', '138,92'], ['152,88', '127,72'], ['142,70', '118,52'],
            ['132,50', '112,32'],
          ],
          color: '#388E3C',
          opacity: 0.9,
      ...
      {[
        {
          ...
          grad: 'frondGrad',
          lines: [
            ['365,102', '385,85'], ['390,92', '412,75'], ['415,82', '438,68'],
            ['440,75', '458,65'], ['365,108', '380,122'], ['390,102', '408,115'],
            ['415,95', '435,105'],
          ],
          color: '#2E7D32',
          opacity: 0.92,
        },
        {
          ...
          grad: 'frondGrad',
          lines: [
            ['370,132', '385,120'], ['395,148', '412,135'], ['420,168', '438,155'],
            ['370,138', '380,158'], ['395,158', '407,178'], ['420,180', '432,200'],
          ],
          color: '#2E7D32',
          opacity: 0.85,
        },
        {
          ...
          grad: 'frondGrad2',
          lines: [
            ['320,105', '305,90'], ['300,98', '285,85'], ['280,92', '268,82'],
            ['320,112', '308,125'], ['300,108', '288,120'],
          ],
          color: '#388E3C',
          opacity: 0.88,
        },
        {
          ...
          grad: 'frondGrad2',
          lines: [
            ['350,90', '338,72'], ['360,65', '350,45'], ['370,40', '362,20'],
            ['355,98', '372,90'], ['368,75', '385,65'], ['378,50', '392,38'],
          ],
          color: '#388E3C',
          opacity: 0.85,
        },
        {
          ...
          solidFill: '#388E3C',
          lines: [
            ['365,120', '380,108'], ['390,122', '408,112'], ['415,128', '432,120'],
            ['365,128', '378,142'], ['390,132', '405,145'],
          ],
          color: '#2E7D32',
          opacity: 0.88,
        },
...
export function MaturePalm({ seed = 0 }: MaturePalmProps) {
  const isWindSwept = seed % 2 === 1
  return isWindSwept ? <WindSweptPalm /> : <MaturePalmVariant />
}
